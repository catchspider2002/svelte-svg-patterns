  ...
  <div class="container mx-auto">
    ...
    <div>
      <ul id="logs">
        ...
        <li>Added French translation by David Prioul available <a href="https://fr.pattern.monster">here</a></li>
        <li>Added Romanian translation by soem which can be accessed <a href="https://ro.pattern.monster">here</a></li>
