...
<div class="email-octopus-form-wrapper">
  ...
  <form
    method="post"
    action="https://emailoctopus.com/lists/470a75fc-e208-11ea-a3d0-06b4694bee2a/members/embedded/1.3/add"
    ...
    <div class="email-octopus-form-row-consent">
      ...
      <label for="consent">I consent to receiving your weekly newsletter and special offers via email.</label>
    </div>

    <div class="email-octopus-form-row-hp" aria-hidden="true">
      <!-- Do not remove this field, otherwise you risk bot sign-ups -->
      <input type="text" name="hp470a75fc-e208-11ea-a3d0-06b4694bee2a" tabindex="-1" autocomplete="nope" />
    </div>

    <div class="email-octopus-form-row-subscribe">
      <input type="hidden" name="successRedirectUrl" value="" />
      <button type="submit">Join priority list</button>
    </div>
  </form>

  <div class="email-octopus-rewards">
    Powered by
    <a href="https://emailoctopus.com/?urli=bSNXh&amp;utm_medium=user_referral&amp;utm_source=builder" target="_blank">EmailOctopus</a>
  </div>
